...
const stableConflictReasonCodes = new Set([
  ...
  'AFTER_SALE_POLICY_CONCURRENT_CONFLICT',
  'AFTER_SALE_POLICY_IDEMPOTENCY_CONFLICT',
  'AFTER_SALE_POLICY_IDEMPOTENCY_INVALID',
  ...
  'SKU_PHYSICAL_PROFILE_INCOMPLETE',
  'SKU_UNAVAILABLE',
  'STOCK_INSUFFICIENT',
  'VERSION_CONFLICT',
]);
