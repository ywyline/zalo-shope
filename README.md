...
- B2b 凭证上传/真实扫描/claim/保护读取/删除补偿、B3-B7、UI、生产政策/enforcement、部署和发布都没有授权；
  相关能力保持 contract-only 或失败关闭。
